package com.anzy.frame.base.service.impl;

import com.anzy.frame.base.service.BaseService;
import com.anzy.frame.utils.ClassUtils;
...
import static com.anzy.frame.comm.Constants.SESN_USR_UID;
...
public abstract class BaseServiceImpl<M extends BaseMapper<T>, T> implements BaseService<T> {
    ...
    private T setCreateParam(T entity, HttpServletRequest request) {
        try {
            String userId = request.getSession().getAttribute(SESN_USR_UID).toString();
